<p align="center">
  <img src="https://raw.githubusercontent.com/DaoyuanLi2816/mini-verl/v0.2.6/docs/banner.svg" alt="miniVERL — on-policy distillation for tool-using agents on one GPU" width="880">
</p>
...
[![License](https://img.shields.io/badge/license-Apache--2.0-blue)](https://github.com/DaoyuanLi2816/mini-verl/blob/v0.2.6/LICENSE)
...
<p align="center">
  ...
  <a href="https://github.com/DaoyuanLi2816/mini-verl/blob/v0.2.6/docs/single-gpu-guide.md">Bring your own GPU</a> ·
...
[Read the math](https://github.com/DaoyuanLi2816/mini-verl/blob/v0.2.6/docs/math.md)
...
| Ray, FSDP, DeepSpeed, vLLM, VLMs, cross-tokenizer, PPO/GRPO | **no** — see [limitations](https://github.com/DaoyuanLi2816/mini-verl/blob/v0.2.6/docs/limitations.md) |
...
See [limitations](https://github.com/DaoyuanLi2816/mini-verl/blob/v0.2.6/docs/limitations.md).
...
[full result and legacy transcript diagnosis](https://github.com/DaoyuanLi2816/mini-verl/blob/v0.2.6/docs/rtx4080-baselines.md).

![Two-seed protocol-teacher benchmark](https://raw.githubusercontent.com/DaoyuanLi2816/mini-verl/v0.2.6/docs/gpu-calc-hard-equal-update-v2.svg)

| Artifact | Role |
| --- | --- |
| [Default recipe](https://github.com/DaoyuanLi2816/mini-verl/blob/v0.2.6/recipes/qwen_consumer_gpu_calc.yaml) | protocol-qualified default |
| [Schema-v2 benchmark](https://github.com/DaoyuanLi2816/mini-verl/blob/v0.2.6/benchmarks/results/gpu-calc-hard-equal-update-v2.json) | frozen five-arm result |
| [Raw-teacher recipe](https://github.com/DaoyuanLi2816/mini-verl/blob/v0.2.6/recipes/qwen_consumer_gpu_calc_raw_teacher.yaml) | historical control; not default |
...
SFT. [Trace](https://github.com/DaoyuanLi2816/mini-verl/blob/v0.2.6/docs/rtx4080-baselines.md).
...
[`single-GPU guide`](https://github.com/DaoyuanLi2816/mini-verl/blob/v0.2.6/docs/single-gpu-guide.md) before changing the recipe.
...
See [`docs/design.md`](https://github.com/DaoyuanLi2816/mini-verl/blob/v0.2.6/docs/design.md).
...
`loss_top_k` with an optional tail bucket. See [`docs/math.md`](https://github.com/DaoyuanLi2816/mini-verl/blob/v0.2.6/docs/math.md).
...
[`docs/benchmarking.md`](https://github.com/DaoyuanLi2816/mini-verl/blob/v0.2.6/docs/benchmarking.md) on the hardware recorded in each
result file. Nothing is estimated or extrapolated.

* **RTX 4080, real models** — [`docs/rtx4080-baselines.md`](https://github.com/DaoyuanLi2816/mini-verl/blob/v0.2.6/docs/rtx4080-baselines.md)
...
* **CPU, toy models** — `recipes/toy_cpu.yaml` moves task success from 0.0% to
  ...
  them. See [`benchmarks/README.md`](https://github.com/DaoyuanLi2816/mini-verl/blob/v0.2.6/benchmarks/README.md) for why the toy
...
[`docs/teacher-adapters.md`](https://github.com/DaoyuanLi2816/mini-verl/blob/v0.2.6/docs/teacher-adapters.md).

## Limitations

The short version; the full list is in [`docs/limitations.md`](https://github.com/DaoyuanLi2816/mini-verl/blob/v0.2.6/docs/limitations.md).
...
See [`docs/reproducibility.md`](https://github.com/DaoyuanLi2816/mini-verl/blob/v0.2.6/docs/reproducibility.md) and the concise
[`compatibility policy`](https://github.com/DaoyuanLi2816/mini-verl/blob/v0.2.6/docs/compatibility.md).
...
actually ran. See [`docs/comparisons.md`](https://github.com/DaoyuanLi2816/mini-verl/blob/v0.2.6/docs/comparisons.md).
...
See [CITATION.cff](https://github.com/DaoyuanLi2816/mini-verl/blob/v0.2.6/CITATION.cff) and [CHANGELOG.md](https://github.com/DaoyuanLi2816/mini-verl/blob/v0.2.6/CHANGELOG.md).
Contributions: [CONTRIBUTING.md](https://github.com/DaoyuanLi2816/mini-verl/blob/v0.2.6/CONTRIBUTING.md). Security:
[SECURITY.md](https://github.com/DaoyuanLi2816/mini-verl/blob/v0.2.6/SECURITY.md).

## License

Apache-2.0. See [LICENSE](https://github.com/DaoyuanLi2816/mini-verl/blob/v0.2.6/LICENSE) and
[THIRD_PARTY_NOTICES.md](https://github.com/DaoyuanLi2816/mini-verl/blob/v0.2.6/THIRD_PARTY_NOTICES.md).

Chinese translation: [README.zh-CN.md](https://github.com/DaoyuanLi2816/mini-verl/blob/v0.2.6/README.zh-CN.md).
