# 90-second verified-bridge demo
...
python -c "import json; p=json.load(open('_demo-bundle/provenance/compatibility-report.json')); print(p['unsupported_semantics']); print('distributed:', p['distributed_execution_status'])"
...
Narration: “This proves that the handoff is pinned, standard, loadable,
privacy-checked and checksummed. It does not prove a distributed verl job ran;
that status is deliberately `not tested`.”
