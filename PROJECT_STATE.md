...
| remaining gate | push the evidence-bound head, complete the remote compatibility/build matrix, finalize `0.2.4` metadata, merge only when green, then run the authorized tag-only public release and independent install/hash checks |
